<template>
	<section>
		...
		<el-table :data="list" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="number_pay_money" label="号码费收款金额" width="180">
			</el-table-column>
			<el-table-column prop="call_customer_pay_money" label="通信费客户自备线路收款金额" width="180">
			</el-table-column>
			<el-table-column prop="call_card_pay_money" label="通信费卡槽费收款金额" width="180">
			</el-table-column>
			<el-table-column prop="call_year_pay_money" label="通信费包年正常收款金额" width="180">
			</el-table-column>
			<el-table-column prop="robot_pay_money" label="机器人费收款金额" width="180">
			</el-table-column>
